...
- ***torchaudio-augmentations*** : It is the cloned directory of *torchaudio-augmentations* package. We need to install it as it is required in ccc-wav2vec embedding extraction.

- ***data2vec-aqc*** : It is the cloned directory of *data2vec-aqc* package. We need to install it as it is required in ccc-wav2vec embedding extraction.
